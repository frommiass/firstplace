...
Пример посылаемого решения (см. ["Baseline решение"](#baseline-решение)) можно найти в репозитории в директории [src/submit](https://gitverse.ru/ai-forever/memory_aij2025/content/main/src/submit). 
